...
- Updated `local_data_impl` to ^0.0.5
...
- Updated `get_it_di_global_variable` to ^0.0.7
...
- Introduced `IRestApiConfig` interface and `DefaultRestApiConfig` implementation with configurable
